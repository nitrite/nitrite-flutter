...
void main() {
  // A fresh store per test: the suite's shared path would otherwise carry one
  // test's documents into the next, and a paging assertion reads that as a
  // wrong page rather than as leftover state.
  late String dbPath;
